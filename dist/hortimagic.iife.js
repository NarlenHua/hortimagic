  ...
  <div class="footer" style="background-color: ${this.footerBackgroundColor};width:${this.width}px;">
    ...
    >
      ${this.rightButtonText}
                ...
                `}_handleClose(){this.hideMovePanel()}handleLeftButtonClick(){this.dispatchEvent(new CustomEvent("left-button-click",{detail:{message:"左侧按钮被点击"},bubbles:!0,composed:!0}))}handleRightButtonClick(){this.dispatchEvent(new CustomEvent("right-button-click",{detail:{message:"右侧按钮被点击"},bubbles:!0,composed:!0}))}};Ve.styles=Ht`
.panel {
  position: absolute;
  display: block;
}
...
`}};Vo.styles=Ht`
    ...
    `,Ro([Be()],Vo.prototype,"_isDragging",2),Ro([Be()],Vo.prototype,"_startX",2),Ro([Be()],Vo.prototype,"_currentTranslate",2),Ro([Be()],Vo.prototype,"_prevTranslate",2),Ro([Be()],Vo.prototype,"_animationId",2),Ro([Be()],Vo.prototype,"_velocity",2),Ro([Be()],Vo.prototype,"_lastX",2),Ro([Be()],Vo.prototype,"_lastTime",2),Ro([Be()],Vo.prototype,"_isOpen",2),Ro([Be()],Vo.prototype,"rightButtonName",2),Ro([Be()],Vo.prototype,"rightButtonCallback",2),Ro([Ie(".slider")],Vo.prototype,"sliderElement",2),Ro([Ie(".content")],Vo.prototype,"contentElement",2),Ro([Ie(".left-actions")],Vo.prototype,"leftActions",2),Ro([Ie(".right-actions")],Vo.prototype,"rightActions",2),Vo=Ro([Pe("hm-swipe-cell")],Vo);const qo=Object.freeze(Object.defineProperty({__proto__:null,get HmSwipeCell(){return Vo}},Symbol.toStringTag,{value:"Module"}));var Wo=Object.defineProperty,Go=Object.getOwnPropertyDescriptor,Xo=(t,e,o,i)=>{for(var n,s=i>1?void 0:i?Go(e,o):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(i?n(e,o,s):n(s))||s);return i&&s&&Wo(e,o,s),s};let Jo=class extends He{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.loading=!1,this.color="#1890ff",this.openContent="",this.closeContent="",this.openIcon="",this.closeIcon=""}change(){this.disabled||this.loading||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent("hm-switch-change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))}render(){return ge`
<div
...
<hm-accordion>
    ...
    <hm-swipe-cell>
      <div slot="left-actions">
        <hm-button
          icon="delete"
          @hm-button-click="${()=>{wt(t)?zi.success(ji,"脚本删除成功"):zi.error(ji,"脚本已经不在脚本列表中"),this.storeSnap=G.snapshot(X)}}"
          >删除</hm-button
        >
      </div>
      <hm-cell title-name="${t.name}" descripthion="${t.url}">
        <hm-switch
          ?checked="${t.enable}"
          @hm-switch-change="${e=>{yt(new vt(t.name,t.url,e.detail.checked))?zi.success(ji,"脚本修改成功"):zi.error(ji,"脚本修改失败")}}"
        ></hm-switch>
      </hm-cell>
      <div slot="right-actions">
        ...
        <hm-button
          ...
          @hm-button-click="${()=>{_t(t)?zi.success(ji,"脚本运行成功"):zi.error(ji,"脚本运行失败,脚本已经在运行了")}}"
          >运行</hm-button
        >
      </div>
    </hm-swipe-cell>
...
</hm-accordion>`}}Li([Be({type:String})],Bi.prototype,"scriptName"),Li([Be({type:String})],Bi.prototype,"scriptUrl"),Li([Be({type:Boolean})],Bi.prototype,"scriptEnable"),Li([Be({type:Boolean})],Bi.prototype,"scriptIngected"),Li([Be({type:Boolean})],Bi.prototype,"dialogOpen");const Ii={name:"hortimagic",private:!1,version:"1.1.3",changelog:"优化了滑动单元格的拖动逻辑，优化了单元格默认的显示内容",author:"Narlen",description:"园艺魔法，花园插件",keywords:["iirose","plugins","hortimagic"],repository:{type:"git",url:"https://github.com/NarlenHua/hortimagic.git"},license:"MIT",type:"module",scripts:{dev:"vite",build:"tsc && vite build",preview:"vite preview"},dependencies:{lit:"^3.3.1",terser:"^5.44.0",valtio:"^2.2.0","vite-plugin-dts":"^4.5.4"},devDependencies:{"@types/node":"^24.9.1",typescript:"~5.9.3",vite:"^7.1.7"},main:"dist/Horticraft.life.js",module:"dist/HortiCraft.es.js",typings:"dist/index.d.ts",types:"dist/index.d.ts",files:["dist","scripts","src","types"]};class Di extends He{constructor(){super(...arguments),this.storeSnap=G.snapshot(X)}static{this.styles=Ht`
        .config-item {
            margin: 10px 0;
        }
    `}render(){return ge`
