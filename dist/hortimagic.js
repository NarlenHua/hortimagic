  ...
  <div class="footer" style="background-color: ${this.footerBackgroundColor};width:${this.width}px;">
    ...
    >
      ${this.rightButtonText}
                ...
                `}_handleClose(){this.hideMovePanel()}_handleLeftButtonClick(){this.dispatchEvent(new CustomEvent("left-button-click",{detail:{message:"左侧按钮被点击"},bubbles:!0,composed:!0}))}_handleRightButtonClick(){this.dispatchEvent(new CustomEvent("right-button-click",{detail:{message:"右侧按钮被点击"},bubbles:!0,composed:!0}))}};me.styles=it`
.panel {
  position: absolute;
  display: block;
}
...
`,xe([le({type:String})],Ce.prototype,"icon",2),xe([le({type:String})],Ce.prototype,"size",2),Ce=xe([ne("hm-icon")],Ce);const Ae=Object.freeze(Object.defineProperty({__proto__:null,get HmIcon(){return Ce},getIcon:ke,iconMap:Se,registerIcon:function(t,e){Se.set(t,e)}},Symbol.toStringTag,{value:"Module"}));var Ee=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,Me=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?Oe(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&Ee(e,i,s),s};let Te=class extends ie{constructor(){super(...arguments),this.icon="magic-wand",this.content="HortiMagicMenu",this.flag=!1,this.isMenuItem=!1}handleClick(){this.isMenuItem||(this.flag=!this.flag),this.dispatchEvent(new CustomEvent("hm-menu-click"))}render(){return Dt`
<div
...
`,Me([le({type:String})],Te.prototype,"icon",2),Me([le({type:String})],Te.prototype,"content",2),Me([le({type:Boolean})],Te.prototype,"flag",2),Me([le({type:Boolean})],Te.prototype,"isMenuItem",2),Te=Me([ne("hm-menu")],Te);const He=Object.freeze(Object.defineProperty({__proto__:null,get HmMenu(){return Te}},Symbol.toStringTag,{value:"Module"}));var Pe=Object.defineProperty,je=Object.getOwnPropertyDescriptor,ze=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?je(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&Pe(e,i,s),s};let Be=class extends ie{constructor(){super(...arguments),this.leftIcon="magic-wand",this.title="HortiMagic",this.content="Hello iirose!",this.rightIcon="",this.displayTime=999999,this.color="rgb(33,33,33)",this.backgroundColor="rgba(255,255,255,0.9)"}firstUpdated(){this.displayTime>0&&setTimeout(()=>{this.startLeaveAnimation()},this.displayTime)}startLeaveAnimation(){this.setAttribute("leaving",""),setTimeout(()=>{this.remove()},300)}render(){return Dt`
<div
...
`,ze([le()],Be.prototype,"leftIcon",2),ze([le()],Be.prototype,"title",2),ze([le()],Be.prototype,"content",2),ze([le()],Be.prototype,"rightIcon",2),ze([le()],Be.prototype,"displayTime",2),ze([le()],Be.prototype,"color",2),ze([le()],Be.prototype,"backgroundColor",2),Be=ze([ne("hm-notification")],Be);const Ie=Object.freeze(Object.defineProperty({__proto__:null,get HmNotification(){return Be}},Symbol.toStringTag,{value:"Module"}));var De=Object.defineProperty,Ne=Object.getOwnPropertyDescriptor,Ue=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?Ne(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&De(e,i,s),s};let Le=class extends ie{constructor(){super(...arguments),this.icon="",this.content="",this.fontSize="14px",this.color="",this.background="",this.width="",this.height="",this.enable=!0,this.loading=!1}render(){const t=`\n          ${this.color?`color: ${this.color};`:""}\n          ${this.background?`background: ${this.background};`:""}\n          ${this.width?`width: ${this.width};`:""}\n          ${this.height?`height: ${this.height};`:""}\n          ${this.fontSize?`font-size: ${this.fontSize};`:"14px"}\n        `;return Dt`
          <button 
            class="button" 
            style="${t}"
        ...
        `}_handleClick(t){this.enable&&!this.loading?this.dispatchEvent(new CustomEvent("hm-button-click")):t.stopPropagation()}};Le.styles=it`
      :host {
        display: inline-block;
      }
    ...
    `,Ue([le({type:String})],Le.prototype,"icon",2),Ue([le({type:String})],Le.prototype,"content",2),Ue([le({type:String})],Le.prototype,"fontSize",2),Ue([le({type:String})],Le.prototype,"color",2),Ue([le({type:String})],Le.prototype,"background",2),Ue([le({type:String})],Le.prototype,"width",2),Ue([le({type:String})],Le.prototype,"height",2),Ue([le({type:Boolean})],Le.prototype,"enable",2),Ue([le({type:Boolean})],Le.prototype,"loading",2),Le=Ue([ne("hm-button")],Le);const Ve=Object.freeze(Object.defineProperty({__proto__:null,get HmButton(){return Le}},Symbol.toStringTag,{value:"Module"}));var Re=Object.defineProperty,qe=Object.getOwnPropertyDescriptor,We=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?qe(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&Re(e,i,s),s};let Xe=class extends ie{constructor(){super(...arguments),this.titleName="单元格",this.descripthion="描述信息",this.content="内容",this.titleClickCallback=()=>{},this.contentClickCallback=()=>{}}render(){return Dt`
...
`}};Ye.styles=it`
    ...
    `,Ze([le()],Ye.prototype,"_isDragging",2),Ze([le()],Ye.prototype,"_startX",2),Ze([le()],Ye.prototype,"_currentTranslate",2),Ze([le()],Ye.prototype,"_prevTranslate",2),Ze([le()],Ye.prototype,"_animationId",2),Ze([le()],Ye.prototype,"_velocity",2),Ze([le()],Ye.prototype,"_lastX",2),Ze([le()],Ye.prototype,"_lastTime",2),Ze([le()],Ye.prototype,"_isOpen",2),Ze([le()],Ye.prototype,"rightButtonName",2),Ze([le()],Ye.prototype,"rightButtonCallback",2),Ze([ae(".slider")],Ye.prototype,"sliderElement",2),Ze([ae(".content")],Ye.prototype,"contentElement",2),Ze([ae(".left-actions")],Ye.prototype,"leftActions",2),Ze([ae(".right-actions")],Ye.prototype,"rightActions",2),Ye=Ze([ne("hm-swipe-cell")],Ye);const Ke=Object.freeze(Object.defineProperty({__proto__:null,get HmSwipeCell(){return Ye}},Symbol.toStringTag,{value:"Module"}));var Qe=Object.defineProperty,ti=Object.getOwnPropertyDescriptor,ei=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?ti(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&Qe(e,i,s),s};let ii=class extends ie{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.loading=!1,this.color="#1890ff",this.openContent="",this.closeContent="",this.openIcon="",this.closeIcon=""}change(){this.disabled||this.loading||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent("hm-switch-change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))}render(){return Dt`
<div
...
>
  <div class="switch-inner">
    ...
    `,ei([le({type:Boolean})],ii.prototype,"checked",2),ei([le({type:Boolean})],ii.prototype,"disabled",2),ei([le({type:Boolean})],ii.prototype,"loading",2),ei([le({type:String})],ii.prototype,"color",2),ei([le({type:String,attribute:"open-content"})],ii.prototype,"openContent",2),ei([le({type:String,attribute:"close-content"})],ii.prototype,"closeContent",2),ei([le({type:String,attribute:"open-icon"})],ii.prototype,"openIcon",2),ei([le({type:String,attribute:"close-icon"})],ii.prototype,"closeIcon",2),ii=ei([ne("hm-switch")],ii);const oi=Object.freeze(Object.defineProperty({__proto__:null,get HmSwitch(){return ii}},Symbol.toStringTag,{value:"Module"}));var ni=Object.defineProperty,si=Object.getOwnPropertyDescriptor,ri=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?si(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&ni(e,i,s),s};let li=class extends ie{constructor(){super(...arguments),this.maxHeight="500px",this.items=[],this.titleContent="标题内容",this.expanded=!1}togglePanel(){this.expanded=!this.expanded}render(){return Dt`
      <div class="accordion-container" style="max-height: ${this.maxHeight}">
        <div class="accordion-header" @click=${this.togglePanel}>
          ...
          <div class="accordion-toggle">
            ${this.expanded?Dt`<hm-icon icon="arrow-up"></hm-icon>`:Dt`<hm-icon icon="arrow-down"></hm-icon>`}
          </div>
        </div>
  ...
  `,ri([le({type:String,attribute:"max-height"})],li.prototype,"maxHeight",2),ri([le({type:Array})],li.prototype,"items",2),ri([le({type:String,attribute:"title-content"})],li.prototype,"titleContent",2),ri([le({type:Boolean})],li.prototype,"expanded",2),li=ri([ne("hm-accordion")],li);const ai=Object.freeze(Object.defineProperty({__proto__:null,get HmAccordion(){return li}},Symbol.toStringTag,{value:"Module"}));var ci=Object.defineProperty,hi=Object.getOwnPropertyDescriptor,di=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?hi(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&ci(e,i,s),s};let pi=class extends ie{constructor(){super(...arguments),this.type="text",this.icon="",this.label="输入框",this.placeholder="",this.enable=!0,this.readonly=!1,this.value=""}_handleKeyDown(t){t.stopPropagation()}_handleInput(t){const e=t.target;this.value=e.value,this.dispatchEvent(new CustomEvent("hm-input-change",{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){return Dt`
...
`,di([le({type:String})],pi.prototype,"type",2),di([le({type:String})],pi.prototype,"icon",2),di([le({type:String})],pi.prototype,"label",2),di([le({type:String})],pi.prototype,"placeholder",2),di([le({type:Boolean})],pi.prototype,"enable",2),di([le({type:Boolean})],pi.prototype,"readonly",2),di([le()],pi.prototype,"value",2),pi=di([ne("hm-input")],pi);const ui=Object.freeze(Object.defineProperty({__proto__:null,get HmInput(){return pi}},Symbol.toStringTag,{value:"Module"}));var mi=Object.defineProperty,gi=Object.getOwnPropertyDescriptor,fi=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?gi(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&mi(e,i,s),s};let vi=class extends ie{constructor(){super(...arguments),this.isOpen=!1,this.dialog=this}open(){this.isOpen=!0,this.dispatchEvent(new CustomEvent("hm-dialog-open"))}close(){this.isOpen=!1,this.dispatchEvent(new CustomEvent("hm-dialog-close"))}confirm(){this.close(),this.dispatchEvent(new CustomEvent("hm-dialog-confirm"))}cancel(){this.close(),this.dispatchEvent(new CustomEvent("hm-dialog-cancel"))}updated(t){t.has("isOpen")&&(this.isOpen?this.style.display="block":this.style.display="none")}render(){return Dt`
<div class="overlay"
@click="${this.close}"
></div>
<div class="content">
    ...
    `,fi([le({type:Boolean,attribute:"isopen"})],vi.prototype,"isOpen",2),vi=fi([ne("hm-dialog")],vi);const yi=Object.freeze(Object.defineProperty({__proto__:null,get HmDialog(){return vi}},Symbol.toStringTag,{value:"Module"})),bi=Object.freeze(Object.defineProperty({__proto__:null,hm_accordion:ai,hm_button:Ve,hm_cell:Fe,hm_dialog:yi,hm_icon:Ae,hm_input:ui,hm_menu:He,hm_move_panel:ge,hm_notification:Ie,hm_swipe_cell:Ke,hm_switch:oi},Symbol.toStringTag,{value:"Module"}));let _i=document.createElement("div");function wi(){_i.id="hmMenuHolder";let t=document.querySelector("#functionHolderImg");null!==t&&t.parentElement.insertAdjacentElement("afterend",_i)}const $i=Object.freeze(Object.defineProperty({__proto__:null,initMenuHolder:wi,menuHolder:_i},Symbol.toStringTag,{value:"Module"}));let xi=document.createElement("div");function Si(){xi.id="hmMovePanelHolder",xi.style.zIndex="999999",document.body.append(xi)}const ki=Object.freeze(Object.defineProperty({__proto__:null,initMovePanelHolder:Si,movePanelHolder:xi},Symbol.toStringTag,{value:"Module"}));let Ci=document.createElement("div");function Ai(){Ci.id="hmNotificationHolder",Ci.style.zIndex="999999",document.body.append(Ci)}const Ei=Object.freeze(Object.defineProperty({__proto__:null,initNotificationHolder:Ai,notificationHolder:Ci},Symbol.toStringTag,{value:"Module"}));let Oi=document.createElement("div");function Mi(){Oi.id="hmDialogHolder",Oi.style.zIndex="999999",document.body.append(Oi)}const Ti=Object.freeze(Object.defineProperty({__proto__:null,dialogHolder:Oi,initDialogHolder:Mi},Symbol.toStringTag,{value:"Module"}));var Hi=Object.defineProperty,Pi=(t,e,i,o)=>{for(var n,s=void 0,r=t.length-1;r>=0;r--)(n=t[r])&&(s=n(e,i,s)||s);return s&&Hi(e,i,s),s};class ji extends ie{constructor(){super(...arguments),this.dialogOpen=!1,this.message="请做出选择",this.closeCallback=null,this.cancelCallback=null,this.confirmCallback=null}handelClick(){this.dispatchEvent(new CustomEvent("hmclick"))}static{this.styles=it`
`}render(){return Dt`
<hm-dialog
...
>
  <p>${this.message}</p>
        ...
        `}}Pi([le({type:Boolean})],ji.prototype,"dialogOpen"),Pi([le({type:String})],ji.prototype,"message"),Pi([le({type:Function})],ji.prototype,"closeCallback"),Pi([le({type:Function})],ji.prototype,"cancelCallback"),Pi([le({type:Function})],ji.prototype,"confirmCallback");const zi=document.createElement("hm-dialog-app");async function Bi(){customElements.define("hm-dialog-app",ji),zi.dialogOpen=!1,zi.message="请做出选择",zi.closeCallback=null,zi.cancelCallback=null,zi.confirmCallback=null,Oi.append(zi)}const Ii=Object.freeze(Object.defineProperty({__proto__:null,HmDialogApp:ji,dialogApp:zi,initDialogApp:Bi},Symbol.toStringTag,{value:"Module"})),Di={success(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(57, 231, 34, 0.7)",o.color="rgb(255,255,255)",Ci.append(o)},warning(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(255,193,7,0.7)",o.color="rgb(255,255,255)",Ci.append(o)},error(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(255,0,0,0.7)",o.color="rgb(255,255,255)",Ci.append(o)},normal(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(33,33,33,0.7)",o.color="rgb(255,255,255)",Ci.append(o)}};const Ni=Object.freeze(Object.defineProperty({__proto__:null,confirm:function(t,e,i,o){zi.message=t,zi.confirmCallback=e||null,zi.cancelCallback=i||null,zi.closeCallback=o||null,zi.dialogOpen=!0},notice:Di},Symbol.toStringTag,{value:"Module"}));var Ui=Object.defineProperty,Li=(t,e,i,o)=>{for(var n,s=void 0,r=t.length-1;r>=0;r--)(n=t[r])&&(s=n(e,i,s)||s);return s&&Ui(e,i,s),s};class Vi extends ie{constructor(){super(...arguments),this.scriptName="",this.scriptUrl="",this.scriptEnable=!0,this.scriptIngected=!1,this.dialogOpen=!1,this.scriptList=U}render(){return Dt`
<hm-dialog
  ?isopen="${this.dialogOpen}"
  @hm-dialog-close="${()=>{this.dialogOpen=!1}}"
  @hm-dialog-confirm="${()=>{if(""==this.scriptName.trim()||""==this.scriptUrl.trim())return void Di.error("脚本管理","请填写完整的脚本信息");this.scriptEnable=!0,this.scriptIngected=!1,L(new N(this.scriptName,this.scriptUrl,this.scriptEnable,this.scriptIngected)),X(),this.scriptList=U}}"
>
  <h2>修改或添加脚本</h2>
  <hm-input
    label="脚本名称"
...
<hm-swipe-cell>
  <div slot="left-actions">
    <hm-button
      @hm-button-click="${()=>{V(t),X(),this.scriptList=U}}"
      >删除</hm-button
    >
  </div>
  <hm-cell
  ...
  <div slot="right-actions">
    ...
    <hm-button
      ?enable="${!t.ingected}"
      @hm-button-click="${()=>{t.ingected=R(t),L(t),this.scriptList=U}}"
      >运行</hm-button
    >
  </div>
</hm-swipe-cell>
...
`)}
  <div slot="footer">
    ...
    `}}Li([le({type:String})],Vi.prototype,"scriptName"),Li([le({type:String})],Vi.prototype,"scriptUrl"),Li([le({type:Boolean})],Vi.prototype,"scriptEnable"),Li([le({type:Boolean})],Vi.prototype,"scriptIngected"),Li([le({type:Boolean})],Vi.prototype,"dialogOpen"),Li([le({type:Array})],Vi.prototype,"scriptList");const Ri={name:"hortimagic",private:!1,version:"1.0.4dev2",changelog:"增加了存储库",author:"Narlen",description:"园艺魔法，花园插件",keywords:["iirose","plugins","hortimagic"],repository:{type:"git",url:"https://github.com/NarlenHua/hortimagic.git"},license:"MIT",type:"module",scripts:{dev:"vite",build:"tsc && vite build",preview:"vite preview"},dependencies:{lit:"^3.3.1",terser:"^5.44.0","tiny-emitter":"^2.1.0","vite-plugin-dts":"^4.5.4"},devDependencies:{"@types/node":"^24.9.1",typescript:"~5.9.3",vite:"^7.1.7"},main:"dist/Horticraft.life.js",module:"dist/HortiCraft.es.js",typings:"dist/index.d.ts",types:"dist/index.d.ts",files:["dist","src/components","types"]};var qi=Object.defineProperty;class Wi extends ie{constructor(){super(...arguments),this.allowHortimagicNotice=!0}static{this.styles=it`
`}render(){return Dt`
 ...
 <hm-switch 
    ...
    @hm-switch-change="${t=>{}}"
  ></hm-switch>
`}}async function Xi(){try{Ai(),Mi(),await Bi(),wi(),Si(),Di.normal(Ri.name,"注入网络钩子函数"),await O(),Di.normal(Ri.name,"注入钩子函数"),z(),I(),Di.normal(Ri.name,"注入脚本"),F(),Di.normal(Ri.name,"生成菜单");let t=document.createElement("hm-menu");t.content="HortiMagic",t.isMenuItem=!1;let e=function(){customElements.define("hm-config-app",Wi);let t=document.createElement("hm-move-panel");t.titleContent="设置",t.icon="config",xi.appendChild(t),t.innerHTML="\n  <hm-config-app></hm-config-app>\n  ";let e=document.createElement("hm-menu");return e.content="设置",e.isMenuItem=!0,e.icon="config",e.addEventListener("hm-menu-click",function(){t.putTopToggel()}),e}(),i=function(){customElements.define("hm-script-app",Vi);let t=document.createElement("hm-move-panel");t.titleContent="脚本管理",t.icon="js",xi.appendChild(t),t.innerHTML="\n  <hm-script-app></hm-script-app>\n  ";let e=document.createElement("hm-menu");return e.content="脚本管理",e.isMenuItem=!0,e.icon="js",e.addEventListener("hm-menu-click",function(){t.putTopToggel()}),e}();t.addEventListener("hm-menu-click",function(){e.flag=t.flag,i.flag=t.flag}),_i.append(t,e,i),Di.success(Ri.name,`${Ri.version} 已加载`)}catch(t){}}((t,e,i)=>{for(var o,n=void 0,s=t.length-1;s>=0;s--)(o=t[s])&&(n=o(e,i,n)||n);n&&qi(e,i,n)})([le({type:Boolean})],Wi.prototype,"allowHortimagicNotice");const Fi=Object.freeze(Object.defineProperty({__proto__:null,init:Xi},Symbol.toStringTag,{value:"Module"})),Ji=Object.freeze(Object.defineProperty({__proto__:null,dialog_app:Ii,main_app:Fi},Symbol.toStringTag,{value:"Module"})),Gi=Object.freeze(Object.defineProperty({__proto__:null,dialog:Ti,menu:$i,move_panel:ki,notification:Ei},Symbol.toStringTag,{value:"Module"})),Zi={name:Ri.name,version:Ri.version,changelog:Ri.changelog,description:Ri.description,author:Ri.author,license:Ri.license,repository:Ri.repository,buildTime:(new Date).toISOString(),ingected:!1};return async function(){await Xi(),Zi.ingected=!0}(),t.apps=Ji,t.components=bi,t.core=Z,t.easy_tools=Ni,t.holders=Gi,t.information=Zi,Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),t}({});
