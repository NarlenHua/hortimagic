...
>
  <div class="switch-inner">
    ...
    `}};ge([he({type:Boolean})],Re.prototype,"checked",void 0),ge([he({type:Boolean})],Re.prototype,"disabled",void 0),ge([he({type:Boolean})],Re.prototype,"loading",void 0),ge([he({type:String})],Re.prototype,"color",void 0),ge([he({type:String,attribute:"open-content"})],Re.prototype,"openContent",void 0),ge([he({type:String,attribute:"close-content"})],Re.prototype,"closeContent",void 0),ge([he({type:String,attribute:"open-icon"})],Re.prototype,"openIcon",void 0),ge([he({type:String,attribute:"close-icon"})],Re.prototype,"closeIcon",void 0),Re=ge([le("hm-switch")],Re);var qe=class extends ne{constructor(...t){super(...t),this.maxHeight="500px",this.items=[],this.titleContent="标题内容",this.expanded=!1}static{this.styles=et`
    :host {
      display: block;
      width: 100%;
  ...
  `}togglePanel(){this.expanded=!this.expanded}render(){return Nt`
    ...
    `}};ge([he({type:String,attribute:"max-height"})],qe.prototype,"maxHeight",void 0),ge([he({type:Array})],qe.prototype,"items",void 0),ge([he({type:String,attribute:"title-content"})],qe.prototype,"titleContent",void 0),ge([he({type:Boolean})],qe.prototype,"expanded",void 0),qe=ge([le("hm-accordion")],qe);var We=class extends ne{constructor(...t){super(...t),this.type="text",this.icon="",this.label="输入框",this.placeholder="",this.disabled=!1,this.readonly=!1,this.value=""}static{this.styles=et`
    :host {
        display: block;
    }
    .input-container {
...
<hm-accordion>
    ...
    <hm-swipe-cell>
      <div slot="left-actions">
        <hm-button
          icon="delete"
          @hm-button-click="${()=>{X.removeScriptFromList(t)?Qe.notice.success(ti,"脚本删除成功"):Qe.notice.error(ti,"脚本已经不在脚本列表中"),this.storeSnap=U.reactive.snapshot(U.HortimagicStore)}}"
          >删除</hm-button
        >
      </div>
      <hm-cell title-name="${t.name}" descripthion="${t.url}">
        <hm-switch
          ?checked="${t.enable}"
          @hm-switch-change="${e=>{let i=new G(t.name,t.url,e.detail.checked);X.updateScriptInList(i)?Qe.notice.success(ti,"脚本修改成功"):Qe.notice.error(ti,"脚本修改失败"),this.storeSnap=U.reactive.snapshot(U.HortimagicStore)}}"
        ></hm-switch>
      </hm-cell>
      <div slot="right-actions">
        ...
        <hm-button
          icon="run"
          ?enable="${!X.injectedUrlList.includes(t.url)}"
          @hm-button-click="${()=>{X.injecteScript(t)?Qe.notice.success(ti,"脚本运行成功"):Qe.notice.error(ti,"脚本运行失败,脚本已经在运行了"),this.storeSnap=U.reactive.snapshot(U.HortimagicStore)}}"
          >运行</hm-button
        >
      </div>
    </hm-swipe-cell>
...
`}};var li=class extends ne{constructor(){super(),this.logList=[],this.foldState=new Map,U.HortimagicStore.logListLength<1&&(U.HortimagicStore.logListLength=50),j.logEmitter.on("log",(t,...e)=>{let i="log";if(e.length>0){const t=e[0];"string"==typeof t&&(t.startsWith("[DEBUG]")?i="debug":t.startsWith("[INFO]")?i="info":t.startsWith("[WARN]")?i="warn":t.startsWith("[ERROR]")&&(i="error"))}const o=[...e];o.length>0&&"string"==typeof o[0]&&["[DEBUG]","[INFO]","[WARN]","[ERROR]"].some(t=>o[0].startsWith(t))&&o.shift();const s={timestamp:new Date,level:i,tag:t,message:o};for(;this.logList.length>=U.HortimagicStore.logListLength;)this.logList.shift();this.logList.push(s),this.requestUpdate()})}static{this.styles=et`
    .log-container {
        height: 400px;
        overflow-y: auto;
        padding: 10px;
...
`}render(){return Nt`
            ...
            <div class="log-container">
                ${this.logList.map(t=>{const e=`${t.timestamp.getTime()}-${t.tag}-${t.level}`,i=this.foldState.get(e)??!1,o=t.message.map(t=>"object"==typeof t?JSON.stringify(t):String(t)).join(" "),s=o.length>100;return Nt`
                        <div class="log-entry">
        ...
        `}formatTime(t){return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}:${String(t.getSeconds()).padStart(2,"0")}.${String(t.getMilliseconds()).padStart(3,"0")}`}clearLogs(){this.logList=[],this.requestUpdate()}toggleFold(t){const e=this.foldState.get(t)??!1;this.foldState.set(t,!e),this.requestUpdate()}};ge([he({type:Array})],li.prototype,"logList",void 0);var ai=i({init:()=>ci});async function ci(){try{U.initStore(),q.initNotificationHolder(),q.initDialogHolder(),await Ye(),q.initMenuHolder(),q.initMovePanelHolder(),Qe.notice.normal(o.name,"注入网络钩子函数"),await D.initSocket(),Qe.notice.normal(o.name,"注入钩子函数"),F.refreshAll(),F.initHooks(),Qe.notice.normal(o.name,"注入脚本"),X.injecteScriptList(),Qe.notice.normal(o.name,"生成菜单");let t=document.createElement("hm-menu");t.content="HortiMagic",t.isMenuItem=!1;let e=function(){customElements.define("hm-config-app",ri);let t=document.createElement("hm-move-panel");t.titleContent="设置",t.icon="config",t.leftButtonText="读取",t.leftIcon="load",t.addEventListener("left-button-click",function(){si()}),t.rightButtonText="保存",t.rightIcon="save",t.addEventListener("right-button-click",function(){oi()}),q.movePanelHolder.appendChild(t),t.innerHTML="\n        <hm-config-app></hm-config-app>\n    ";let e=document.createElement("hm-menu");return e.content="设置",e.isMenuItem=!0,e.icon="config",e.addEventListener("hm-menu-click",function(){t.putTopToggel()}),e}(),i=function(){customElements.define("hm-log-app",li);let t=document.createElement("hm-move-panel");t.titleContent="日志",t.icon="log",t.width=400,q.movePanelHolder.appendChild(t),t.innerHTML="<hm-log-app></hm-log-app>";let e=document.createElement("hm-menu");return e.content="日志",e.isMenuItem=!0,e.icon="log",e.addEventListener("hm-menu-click",function(){t.putTopToggel()}),e}(),s=function(){customElements.define("hm-script-app",ei);let t=document.createElement("hm-move-panel");t.titleContent="脚本管理",t.icon="js",t.leftButtonText="读取",t.leftIcon="load",t.addEventListener("left-button-click",function(){U.loadStore()}),t.rightButtonText="保存",t.rightIcon="save",t.addEventListener("right-button-click",function(){U.saveStore()}),q.movePanelHolder.appendChild(t),t.innerHTML="<hm-script-app> </hm-script-app>\n    ";let e=document.createElement("hm-menu");return e.content="脚本管理",e.isMenuItem=!0,e.icon="js",e.addEventListener("hm-menu-click",function(){t.putTopToggel()}),e}();t.addEventListener("hm-menu-click",function(){e.flag=t.flag,i.flag=t.flag,s.flag=t.flag}),q.menuHolder.append(t,e,i,s),Qe.notice.success(o.name,`${o.version} 已加载`)}catch(t){console.error(t)}}var hi=i({dialog_app:()=>Je,main_app:()=>ai}),{logger:di}=j,{confirm:pi,notice:gi}=Qe,ui={name:o.name,version:o.version,changelog:o.changelog,description:o.description,author:o.author,license:o.license,repository:o.repository,buildTime:"2026-07-26T08:08:05.204Z",injected:!1};return async function(){await ci(),ui.injected=!0}(),Object.defineProperty(t,"apps",{enumerable:!0,get:function(){return hi}}),Object.defineProperty(t,"components",{enumerable:!0,get:function(){return Xe}}),t.confirm=pi,Object.defineProperty(t,"core",{enumerable:!0,get:function(){return J}}),t.easyTools=Qe,t.information=ui,t.logger=di,t.notice=gi,t}({})
