...
`,Te([le({type:String})],Me.prototype,"icon",2),Te([le({type:String})],Me.prototype,"content",2),Te([le({type:Boolean})],Me.prototype,"flag",2),Te([le({type:Boolean})],Me.prototype,"isMenuItem",2),Me=Te([ne("hm-menu")],Me);const Pe=Object.freeze(Object.defineProperty({__proto__:null,get HmMenu(){return Me}},Symbol.toStringTag,{value:"Module"}));var He=Object.defineProperty,je=Object.getOwnPropertyDescriptor,ze=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?je(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&He(e,i,s),s};let Be=class extends ie{constructor(){super(...arguments),this.leftIcon="magic-wand",this.title="HortiMagic",this.content="Hello iirose!",this.rightIcon="",this.displayTime=999999,this.color="rgb(33,33,33)",this.backgroundColor="rgba(255,255,255,0.9)"}firstUpdated(){this.displayTime>0&&setTimeout(()=>{this.startLeaveAnimation()},this.displayTime)}startLeaveAnimation(){this.setAttribute("leaving",""),setTimeout(()=>{this.remove()},300)}render(){return Dt`
<div
...
`,ze([le()],Be.prototype,"leftIcon",2),ze([le()],Be.prototype,"title",2),ze([le()],Be.prototype,"content",2),ze([le()],Be.prototype,"rightIcon",2),ze([le()],Be.prototype,"displayTime",2),ze([le()],Be.prototype,"color",2),ze([le()],Be.prototype,"backgroundColor",2),Be=ze([ne("hm-notification")],Be);const Ie=Object.freeze(Object.defineProperty({__proto__:null,get HmNotification(){return Be}},Symbol.toStringTag,{value:"Module"}));var De=Object.defineProperty,Ue=Object.getOwnPropertyDescriptor,Ne=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?Ue(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&De(e,i,s),s};let Le=class extends ie{constructor(){super(...arguments),this.icon="",this.content="",this.fontSize="14px",this.color="",this.background="",this.width="",this.height="",this.enable=!0,this.loading=!1}render(){const t=`\n          ${this.color?`color: ${this.color};`:""}\n          ${this.background?`background: ${this.background};`:""}\n          ${this.width?`width: ${this.width};`:""}\n          ${this.height?`height: ${this.height};`:""}\n          ${this.fontSize?`font-size: ${this.fontSize};`:"14px"}\n        `;return Dt`
    ...
    `,Ne([le({type:String})],Le.prototype,"icon",2),Ne([le({type:String})],Le.prototype,"content",2),Ne([le({type:String})],Le.prototype,"fontSize",2),Ne([le({type:String})],Le.prototype,"color",2),Ne([le({type:String})],Le.prototype,"background",2),Ne([le({type:String})],Le.prototype,"width",2),Ne([le({type:String})],Le.prototype,"height",2),Ne([le({type:Boolean})],Le.prototype,"enable",2),Ne([le({type:Boolean})],Le.prototype,"loading",2),Le=Ne([ne("hm-button")],Le);const Re=Object.freeze(Object.defineProperty({__proto__:null,get HmButton(){return Le}},Symbol.toStringTag,{value:"Module"}));var qe=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,We=(t,e,i,o)=>{for(var n,s=o>1?void 0:o?Ve(e,i):e,r=t.length-1;r>=0;r--)(n=t[r])&&(s=(o?n(e,i,s):n(s))||s);return o&&s&&qe(e,i,s),s};let Xe=class extends ie{constructor(){super(...arguments),this.titleName="单元格",this.descripthion="描述信息",this.content="内容",this.titleClickCallback=()=>{},this.contentClickCallback=()=>{}}render(){return Dt`
...
>
  <p>${this.message}</p>
        ...
        `}}Hi([le({type:Boolean})],ji.prototype,"dialogOpen"),Hi([le({type:String})],ji.prototype,"message"),Hi([le({type:Function})],ji.prototype,"closeCallback"),Hi([le({type:Function})],ji.prototype,"cancelCallback"),Hi([le({type:Function})],ji.prototype,"confirmCallback");const zi=document.createElement("hm-dialog-app");async function Bi(){customElements.define("hm-dialog-app",ji),zi.dialogOpen=!1,zi.message="请做出选择",zi.closeCallback=null,zi.cancelCallback=null,zi.confirmCallback=null,Ei.append(zi)}const Ii=Object.freeze(Object.defineProperty({__proto__:null,HmDialogApp:ji,dialogApp:zi,initDialogApp:Bi},Symbol.toStringTag,{value:"Module"})),Di={success(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(57, 231, 34, 0.7)",o.color="rgb(255,255,255)",Ci.append(o)},warning(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(255,193,7,0.7)",o.color="rgb(255,255,255)",Ci.append(o)},error(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(255,0,0,0.7)",o.color="rgb(255,255,255)",Ci.append(o)},normal(t,e,i=3e3){let o=document.createElement("hm-notification");o.title=t,o.content=e,o.displayTime=i,o.backgroundColor="rgba(33,33,33,0.7)",o.color="rgb(255,255,255)",Ci.append(o)}};const Ui=Object.freeze(Object.defineProperty({__proto__:null,confirm:function(t,e,i,o){zi.message=t,zi.confirmCallback=e||null,zi.cancelCallback=i||null,zi.closeCallback=o||null,zi.dialogOpen=!0},notice:Di},Symbol.toStringTag,{value:"Module"}));var Ni=Object.defineProperty,Li=(t,e,i,o)=>{for(var n,s=void 0,r=t.length-1;r>=0;r--)(n=t[r])&&(s=n(e,i,s)||s);return s&&Ni(e,i,s),s};class Ri extends ie{constructor(){super(...arguments),this.scriptName="",this.scriptUrl="",this.scriptEnable=!0,this.scriptIngected=!1,this.dialogOpen=!1,this.scriptList=N}static{this.styles=it`
:host {
  display:block;
  width: 100%;
}
...
<hm-dialog
  ?isopen="${this.dialogOpen}"
  @hm-dialog-close="${()=>{this.dialogOpen=!1}}"
  @hm-dialog-confirm="${()=>{if(""==this.scriptName.trim()||""==this.scriptUrl.trim())return void Di.error("脚本管理","请填写完整的脚本信息");this.scriptEnable=!0,this.scriptIngected=!1,L(new U(this.scriptName,this.scriptUrl,this.scriptEnable,this.scriptIngected)),X(),this.scriptList=N}}"
>
  <h2>修改或添加脚本</h2>
  <hm-input
    label="脚本名称"
...
<hm-swipe-cell>
  <div slot="left-actions">
    <hm-button
      @hm-button-click="${()=>{R(t),X(),this.scriptList=N}}"
      >删除</hm-button
    >
  </div>
  <hm-cell
  ...
  >
    <hm-switch
      slot="content"
      ?checked="${t.enable}"
      @hm-switch-change="${e=>{t.enable=e.detail.checked,L(t),X(),this.scriptList=N}}"
    ></hm-switch>
  </hm-cell>
  ...
  <div slot="right-actions">
    ...
    <hm-button
      ?enable="${!t.ingected}"
      @hm-button-click="${()=>{t.ingected=q(t),L(t),this.scriptList=N}}"
      >运行</hm-button
    >
  </div>
</hm-swipe-cell>
...
`)}
  <div slot="footer">
    ...
    `}}function qi(){customElements.define("hm-script-app",Ri);let t=document.createElement("hm-move-panel");t.titleContent="脚本管理",t.icon="js",xi.appendChild(t);t.innerHTML="\n  <hm-script-app></hm-script-app>\n  ";let e=document.createElement("hm-menu");return e.content="脚本管理",e.isMenuItem=!0,e.icon="js",e.addEventListener("hm-menu-click",function(){t.putTopToggel()}),e}Li([le({type:String})],Ri.prototype,"scriptName"),Li([le({type:String})],Ri.prototype,"scriptUrl"),Li([le({type:Boolean})],Ri.prototype,"scriptEnable"),Li([le({type:Boolean})],Ri.prototype,"scriptIngected"),Li([le({type:Boolean})],Ri.prototype,"dialogOpen"),Li([le({type:Array})],Ri.prototype,"scriptList");const Vi=Object.freeze(Object.defineProperty({__proto__:null,initScriptApp:qi},Symbol.toStringTag,{value:"Module"})),Wi={name:"hortimagic",private:!1,version:"1.0.4dev2",changelog:"增加了存储库",author:"Narlen",description:"园艺魔法，花园插件",keywords:["iirose","plugins","hortimagic"],repository:{type:"git",url:"https://github.com/NarlenHua/hortimagic.git"},license:"MIT",type:"module",scripts:{dev:"vite",build:"tsc && vite build",preview:"vite preview"},dependencies:{lit:"^3.3.1",terser:"^5.44.0","tiny-emitter":"^2.1.0","vite-plugin-dts":"^4.5.4"},devDependencies:{"@types/node":"^24.9.1",typescript:"~5.9.3",vite:"^7.1.7"},main:"dist/Horticraft.life.js",module:"dist/HortiCraft.es.js",typings:"dist/index.d.ts",types:"dist/index.d.ts",files:["dist","src/components","types"]};async function Xi(){try{Ai(),Ti(),await Bi(),wi(),Si(),Di.normal(Wi.name,"注入网络钩子函数"),await E(),Di.normal(Wi.name,"注入钩子函数"),z(),I(),Di.normal(Wi.name,"注入脚本"),F(),Di.normal(Wi.name,"生成菜单");let t=document.createElement("hm-menu");t.content="HortiMagic",t.isMenuItem=!1;let e=qi();t.addEventListener("hm-menu-click",function(){e.flag=t.flag}),_i.append(t,e),Di.success(Wi.name,`${Wi.version} 已加载`)}catch(t){}}const Fi=Object.freeze(Object.defineProperty({__proto__:null,init:Xi},Symbol.toStringTag,{value:"Module"})),Ji=Object.freeze(Object.defineProperty({__proto__:null,dialog_app:Ii,main_app:Fi,script_app:Vi},Symbol.toStringTag,{value:"Module"})),Gi=Object.freeze(Object.defineProperty({__proto__:null,dialog:Mi,menu:$i,move_panel:ki,notification:Oi},Symbol.toStringTag,{value:"Module"})),Zi={name:Wi.name,version:Wi.version,changelog:Wi.changelog,description:Wi.description,author:Wi.author,license:Wi.license,repository:Wi.repository,buildTime:(new Date).toISOString(),ingected:!1};return async function(){await Xi(),Zi.ingected=!0}(),t.apps=Ji,t.components=bi,t.core=Z,t.easy_tools=Ui,t.holders=Gi,t.information=Zi,Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),t}({});
